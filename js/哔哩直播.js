...
var rule = {
    ...
    limit:8,
    play_parse:true,
    play_json:[{re:'*', json:{jx:0, parse:1,header:{"user-agent":"Mozilla/5.0 (Linux; U; Android 9; zh-CN; MI 9 Build/PKQ1.181121.001) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/57.0.2987.108 UCBrowser/12.5.5.1035 Mobile Safari/537.36"}}}],
    // play_json:0,
    lazy:'',
    double:false,
    推荐:'*',
