var rule = {
    ...
    二级:{is_json:true,title:".result.title;.result.share_sub_title","img":".result.cover","desc":".result.new_ep.desc;.result.publish.pub_time;.result.subtitle","content":".result.evaluate","tabs":"js:pdfa=jsp.pdfa;TABS=['B站']","lists":".episodes"},
    搜索:'ul.tbox_m li;*;*;*;*',
}